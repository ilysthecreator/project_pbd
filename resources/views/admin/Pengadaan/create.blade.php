...
@section('page-title', 'Tambah Pengadaan')
@section('breadcrumb', '/ Data Pengadaan / Tambah')

@section('content')
<div class="form-container">
    <div class="form-header">
        <h2 class="form-title">Form Tambah Pengadaan</h2>
                        ...
                        <tr class="baris-barang">
                            <td>
                                <select name="idbarang[]" class="form-control select-barang" required>
                                    ...
                                    @foreach($barang as $b)
                                        <option value="{{ $b->idbarang }}" data-satuan="{{ $b->nama_satuan }}" data-harga="{{ $b->harga }}">
                                            {{ $b->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <td><input type="number" name="harga_satuan[]" class="form-control harga-satuan" min="0" value="0" required></td>
...
<style>
    .form-container {
        /* max-width: 1400px; */ /* [UPDATE] Dinonaktifkan agar full-width */
    }
    .form-header {
        display: flex;
    ...
    .form-control {
        ...
        height: 40px; /* [UPDATE] Tinggi form-control eksplisit */
    }
    .form-control:focus {
        outline: none;
        border-color: #2563eb;
    ...
    /* [UPDATE] CSS untuk styling Select2 agar konsisten */
    .select2-container {
        width: 100% !important;
    }
    .select2-container .select2-selection--single {
        height: 40px !important; /* Samakan tinggi dengan .form-control */
        border: 1px solid #d1d5db !important;
        border-radius: 6px !important;
    }
    .select2-container--default .select2-selection--single .select2-selection__rendered {
        line-height: 38px !important; /* Vertikal center */
        padding-left: 0.875rem !important; /* Samakan padding */
        color: #374151;
    }
    ...
    .select2-container--default .select2-search--dropdown .select2-search__field {
        border: 1px solid #d1d5db; /* Style search box di dropdown */
    }
    .select2-container--default .select2-selection--single.select2-selection--open {
        border-color: #2563eb !important; /* Warna border saat fokus */
    }
    /* Akhir Style Select2 */
...
$(document).ready(function() {
    // [UPDATE] Inisialisasi Select2 untuk dropdown yang sudah ada
    ...
    $('#btnTambahBaris').click(function() {
        ...
        barisBaru.find('.select-barang').val(''); // Reset pilihan barang
        
        $('#bodyBarang').append(barisBaru);
        
        // [UPDATE] Inisialisasi Select2 HANYA di baris baru
    ...
    $('#formPengadaan').submit(function(e) {
        ...
        $('.select-barang').each(function() {
            ...
            if (val) {
                ...
                // Jika ada baris yang belum dipilih barangnya tapi sudah diisi
